...
import glob
import os
files = glob.glob("target/rp/attachables/modelengine/**/*.json")
texture_done = []
for file in files:
    try:
        with open(file, "r") as f:
            ...
            texture = f"target/rp/{texture_file}.png"
...
print(texture_done)
print("[meg3] Completed attachable material and texture processing")
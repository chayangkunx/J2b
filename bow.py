...
if os.path.exists("assets/minecraft/models/item/bow.json"):
    with open("assets/minecraft/models/item/bow.json") as f:
        data = json.load(f)
        ...
        if data["check"] == 4:
            ...
            for i in range(4):
                ...
                with open(fa, "r") as f:
                    ...
                    is2Dbow =  Bow_Util.is2Dbow(glob.glob(f"target/rp/models/blocks/{namespace}/{path}.json")[0])
                    if is2Dbow:
